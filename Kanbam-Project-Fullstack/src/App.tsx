    ...
    <div id="container" className="flex flex-col min-h-screen bg-white">
      <div id="header" className="flex-col">
        <div className="px-5 py-6 flex items-center justify-center border-b border-3 border-violet-300 border-solid ">
          <h1 className="text-base font-bold">Kanbam</h1>
        </div>
      </div>
      <div
        id="main"
      ...
      >
        ...
        <div className="flex w-8/12 h-auto py-10 flex-row justify-between mt-5">

          <div className="flex-1 py-10 mx-5 bg-violet rounded-lg flex flex-col items-center justify-between border-4 mt-5  w-auto mb-5 border-3 border-violet-200 border-solid  p-4 h-96 overflow-x-auto">
            <div className="flex flex-col items-center justify-center h-auto w-auto">
              <h1 className="border-b w-full text-center mb-2">Do</h1>
              {doList.map((DoStr, indice) => (
                <div key={indice} className="flex flex-row items-center justify-center bg-slate-50 p-3">
                  <h1 className="text-center p-1 border-r w-max mx-1 ml-4">{DoStr}</h1>
          ...
          <div className="flex-1 mx-5 bg-violet rounded-lg flex flex-col items-center justify-between border-4 w-full mt-5 mb-5 border-3 border-violet-200 border-solid p-4 h-96 overflow-x-auto">
            <div className="flex flex-col items-center justify-center h-auto w-auto">
          ...
          <div className="flex-1 mx-5 bg-violet rounded-lg flex flex-col items-center justify-between border-4 mt-5 w-auto border-3 border-violet-200 border-solid p-4 h-96 overflow-x-auto">
            <div className="flex flex-col items-center justify-center h-auto w-auto">
